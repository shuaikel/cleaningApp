...
class SKScreenUtils {
  ...
  double _iosNaviBarHeight = 0.0;
  MediaQueryData? _mediaQueryData;

  static final SKScreenUtils _singleton = SKScreenUtils();

  static SKScreenUtils getInstance() {
    _singleton._init();
    return _singleton;
  }
  ...
  _init() {
    ...
    if (_mediaQueryData != mediaQuery) {
      ...
      _iosNaviBarHeight = mediaQuery.padding.top + 44;
    }
  }
  ...
  /// 导航栏高度
  double get iosNavigationBarHeight => _iosNaviBarHeight;
